	                ...
	                <div>
	                    ...
	                    <div class="space-y-1">
	                        <details class="group" {{ request()->routeIs('planning.*') ? 'open' : '' }}>
                                ...
                                <a href="{{ route('planning.fg-parts.index') }}" 
                                   @class([$subLinkBase, $subActive => request()->routeIs('planning.fg-parts.*'), $subInactive => !request()->routeIs('planning.fg-parts.*')])
                                   @click="mobileSidebarOpen = false">
                                ...
                                <a href="{{ route('planning.wip-parts.index') }}" 
                                   @class([$subLinkBase, $subActive => request()->routeIs('planning.wip-parts.*'), $subInactive => !request()->routeIs('planning.wip-parts.*')])
                                   @click="mobileSidebarOpen = false">
                                ...
                                <a href="{{ route('planning.rm-parts.index') }}" 
                                   @class([$subLinkBase, $subActive => request()->routeIs('planning.rm-parts.*'), $subInactive => !request()->routeIs('planning.rm-parts.*')])
                                   @click="mobileSidebarOpen = false">
    ...
    <nav class="flex-1 px-4 pb-6 pt-6 space-y-6">
        ...
        <div>
            ...
            <details class="group" {{ $outgoingModuleActive ? 'open' : '' }} x-effect="if (sidebarCollapsed) $el.removeAttribute('open')">
                ...
                <div>
                    <div class="px-3 pb-2 text-[11px] font-semibold uppercase tracking-wider text-slate-400" x-show="!sidebarCollapsed" x-cloak>Warehouse</div>
                    <div class="space-y-1" x-show="!sidebarCollapsed" x-cloak>
                        <a
                            href="{{ route('inventory.locations.index') }}"
                            @class([$navLinkBase, $navActive => request()->routeIs('inventory.locations.*'), $navInactive => !request()->routeIs('inventory.locations.*') ])
