<aside class="hidden md:flex w-64 bg-white border-r border-slate-200 min-h-screen flex-col shadow-lg">
    ...
    <nav class="flex-1 px-4 py-6 space-y-6">
        <div class="space-y-1">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all {{ request()->routeIs('dashboard') ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-700 hover:bg-gray-100 hover:text-slate-900' }}">
        ...
        <div class="space-y-2">
            <p class="px-4 text-xs text-gray-400 uppercase tracking-wide">Master Data</p>
            <div class="space-y-1">
                <a href="{{ route('vendors.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all {{ request()->routeIs('vendors.*') ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-700 hover:bg-gray-100 hover:text-slate-900' }}">
                ...
                <a href="{{ route('parts.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all {{ request()->routeIs('parts.*') ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-700 hover:bg-gray-100 hover:text-slate-900' }}">
                ...
                <a href="{{ route('truckings.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all {{ request()->routeIs('truckings.*') ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-700 hover:bg-gray-100 hover:text-slate-900' }}">
                    ...
                    <span class="font-medium text-sm">Trucking Management</span>
                </a>
            </div>
        </div>

        <div class="space-y-2">
            <p class="px-4 text-xs text-gray-400 uppercase tracking-wide">Incoming Material</p>
            <details class="group space-y-1" {{ $incomingModuleActive ? 'open' : '' }}>
                <summary class="flex items-center gap-3 px-4 py-2.5 rounded-lg cursor-pointer list-none transition-all {{ $incomingModuleActive ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-700 hover:bg-gray-100 hover:text-slate-900' }}">
                    <div class="flex items-center gap-3 flex-1">
                        ...
                        <a href="{{ route('incoming-material.dashboard') }}" class="font-semibold text-sm" onclick="event.stopPropagation();">
                            Incoming Material
                        </a>
                    </div>
                    <svg class="h-4 w-4 transition-transform group-open:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m6 9 6 6 6-6"/></svg>
                </summary>
