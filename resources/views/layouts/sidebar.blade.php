<aside class="hidden md:flex w-64 bg-white border-r border-slate-200 min-h-screen flex-col shadow-lg">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1">
        ...
        <a href="{{ route('truckings.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs('truckings.*') ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-700 hover:bg-blue-50 hover:text-blue-600' }}">
        ...
        <details class="group" {{ request()->routeIs('departures.*') ? 'open' : '' }}>
            <summary class="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer list-none transition-all {{ request()->routeIs('departures.*') ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/30' : 'text-slate-700 hover:bg-blue-50 hover:text-blue-600' }}">
                ...
                <span class="font-medium text-sm flex-1">Departure</span>
            ...
            <div class="mt-1 space-y-1 pl-6">
                <a href="{{ route('departures.create') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('departures.create') ? 'bg-blue-100 text-blue-700' : 'text-slate-700 hover:bg-blue-50 hover:text-blue-600' }}">
                    <span>Create Departure</span>
                </a>
                <a href="{{ route('departures.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('departures.index') || request()->routeIs('departures.show') ? 'bg-blue-100 text-blue-700' : 'text-slate-700 hover:bg-blue-50 hover:text-blue-600' }}">
