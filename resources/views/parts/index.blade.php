        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm px-4" x-show="partModal" x-cloak @keydown.escape.window="partModal=false">
            <div class="w-full bg-white rounded-2xl shadow-xl border border-slate-200" :class="subsOpen ? 'max-w-4xl' : 'max-w-lg'">
                ...
                <form :action="partAction" method="POST" class="px-5 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
                    ...
                    <div x-show="partForm.classification === 'FG' || partForm.classification === 'WIP'" x-cloak class="rounded-xl border border-blue-200 bg-blue-50/60 p-4 space-y-3">
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <label class="inline-flex items-center gap-2 text-sm font-semibold text-blue-800">
                                ...
                                <input type="checkbox" name="subcount_enabled" value="1" class="rounded border-blue-300 text-blue-600" x-model="partForm.subcount_enabled">
                                Aktif
                            </label>
                        </div>
                        <div class="grid grid-cols-2 gap-3" x-show="partForm.subcount_enabled" x-cloak>
                            ...
                            <div>
                                <label class="text-xs font-semibold text-slate-700">Process</label>
                                <input name="subcount_process_type" class="mt-1 w-full rounded-lg border-slate-200 text-sm" x-model="partForm.subcount_process_type">
                            </div>
                        </div>
                    </div>
                    <div>
        ...
        <script>
            function partsMaster() {
                return {
                    ...
                    subsOpen: false,
                    vendorSearch: '',
                    partForm: { id: null, customer_ids: [], part_no: '', part_name: '', size: '', model: '', classification: @js($activeTab), status: 'active', consumption_policy: 'backflush_return', subcount_enabled: false, subcount_fg_part_id: '', subcount_rm_part_id: '', subcount_uom: 'PCE', subcount_process_type: 'PG', vendor_ids: [], substitutes_for: [], as_substitute: [] },
                    subEditId: null,
                    subFormAction: '',
                    ...
                    openCreatePart() {
                        ...
                        this.subsOpen = false;
                        this.vendorSearch = '';
                        this.partForm = { id: null, customer_id: '', part_no: '', part_name: '', size: '', model: '', classification: this.activeTab, status: 'active', consumption_policy: 'backflush_return', subcount_enabled: false, subcount_fg_part_id: '', subcount_rm_part_id: '', subcount_uom: 'PCE', subcount_process_type: 'PG', vendor_ids: [], substitutes_for: [], as_substitute: [] };
                        this.subEditId = null;
                        this.subFormAction = '';
                    ...
                    openCreateSubcountPart() {
                        ...
                        this.partForm.subcount_fg_part_id = '';
