...
@php
    ...
    $totalSheets = $arrival->items->sum(fn($i) => (float)($i->qty_goods ?? 0));
    ...
    $country = strtoupper(trim(explode(',', $arrival->port_of_loading ?? 'VIETNAM')[0]));
            ...
            <table style="width:100%; border:none;">
                <tr>
                    <td style="border:none; padding:0; width:50%;">
                        ...
                        &nbsp;&nbsp;{{ strtoupper($arrival->port_of_loading ?? '') }}@if($arrival->country)&nbsp;{{ ', ' . strtoupper($arrival->country) }}@endif
                    </td>
                    <td style="border:none; padding:0; width:50%;">
...
<table class="items-table">
    <thead>
        <tr>
            <th style="width:120px;">12.MARKS & NO. OF<br>PKGS</th>
            <th style="width:120px;">13.DESCRIPTION<br>OF GOODS</th>
            <th style="width:80px;">14.QUANTITY</th>
            <th style="width:90px;">15.UNIT PRICE</th>
            <th style="width:80px;">16.AMOUNT</th>
        </tr>
    </thead>
    <tbody>
        {{-- Marks & Made In row --}}
        <tr>
            <td style="vertical-align:top;">
                ...
                MADE IN {{ $arrival->country ?? 'SOUTH KOREA' }}
            </td>
        ...
        <tr style="border-top:2px solid #000;">
            ...
            <td>&nbsp;</td>
            <td class="text-right text-bold">{{ number_format($totalSheets, 0) }} Sheet &nbsp;&nbsp; {{ number_format($totalNett, 0) }} KGM</td>
            <td>&nbsp;</td>
