                        ...
                        <div class="w-full sm:w-64">
                            ...
                            <div class="relative">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <table class="min-w-full text-sm text-left">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-4">QR Payload</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse ($locations as $loc)
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="max-w-[320px] truncate font-mono text-[11px] text-slate-400 group-hover:text-slate-600 transition-colors"
                                        title="{{ $loc->qr_payload }}">
                                        {{ $loc->qr_payload }}
                                    </div>
                                </td>
                                <td class="px-6 py-4">
        ...
        <div class="w-full max-w-lg bg-white rounded-2xl shadow-xl border border-slate-200">
            ...
            <form :action="formAction" method="POST" class="px-5 py-4 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="location_code" class="mt-1 w-full rounded-xl border-slate-200 uppercase"
                        placeholder="RACK-A1" required x-model="form.location_code">
                </div>
