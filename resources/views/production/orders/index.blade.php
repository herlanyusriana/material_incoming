                            ...
                            <tr class="hover:bg-slate-50 cursor-pointer transition-colors"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($order->transaction_no)
                                        <span
                                            class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800 tracking-wide">{{ $order->transaction_no }}</span>
                                    @else
                                ...
                                <td class="px-6 py-4 text-right">
                                    <button
                                        class="text-indigo-600 hover:text-indigo-900 font-medium text-xs uppercase tracking-wide"
                            ...
                            <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                <div class="px-4 py-6 sm:px-6 bg-slate-50 border-b">
                                    <div class="flex items-start justify-between">
                                        <h2 class="text-lg font-semibold text-slate-900" id="slide-over-title">Order
                                            Details</h2>
