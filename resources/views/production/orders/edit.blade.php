            ...
            <form action="{{ route('production.orders.update', $order) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="process_name" id="process_name" value="{{ old('process_name', $order->process_name) }}"
                            class="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                ...
                <div>
                    ...
                    <input type="text" name="die_name" id="die_name" value="{{ old('die_name', $order->die_name) }}"
                        class="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                ...
                <div id="related-so-section" class="border-t pt-4 mt-2">
                    <label class="block text-sm font-medium text-slate-700 mb-2">Related SO (Incoming RM)</label>
                    ...
                    <div id="so-checkboxes" class="space-y-2 max-h-48 overflow-y-auto bg-slate-50 rounded-xl p-3">
                        <p class="text-xs text-slate-400 italic">Loading related SO...</p>
                    </div>
                </div>
                ...
                <div class="flex justify-between gap-3 pt-4 border-t">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('production.orders.show', $order) }}"
                            class="px-4 py-2 border rounded-lg text-slate-600 hover:bg-slate-50">Back</a>
