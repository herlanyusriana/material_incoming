<x-app-layout>
    ...
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold text-slate-800">First Article Inspections</h2>
        </div>
        ...
        <form method="GET" class="bg-white border rounded-xl shadow-sm p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 items-end">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('production.qc-inspection.index') }}" class="px-3 py-2 rounded-lg border border-slate-200 text-sm font-semibold text-slate-700 hover:bg-slate-50">Reset</a>
            ...
            <table class="w-full text-sm text-left">
                <thead class="text-xs text-slate-500 uppercase bg-slate-50 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-4 font-semibold">Inspection Type</th>
                    ...
                    @forelse($inspections as $inspection)
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('production.qc-inspection.show', $inspection) }}" class="text-indigo-600 hover:text-indigo-900 font-medium text-xs uppercase tracking-wide">
