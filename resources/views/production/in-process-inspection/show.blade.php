<x-app-layout>
    <x-slot name="header">
        In-Process Inspection - {{ $inspection->productionOrder->production_order_number }}
    </x-slot>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white border rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium">IN-PROCESS</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border rounded-xl shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('production.in-process-inspection.update', $inspection) }}">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4" class="w-full rounded-lg border-slate-200" placeholder="Enter inspection notes, issues found, or remarks...">{{ $inspection->notes }}</textarea>
                    </div>

                    <div class="flex justify-between items-center pt-4">
                        <a href="{{ route('production.in-process-inspection.index') }}" class="px-4 py-2 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50">
                            Back to List
                        </a>
