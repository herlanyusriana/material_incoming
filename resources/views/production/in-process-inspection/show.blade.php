            ...
            <form method="POST" action="{{ route('production.in-process-inspection.update', $inspection) }}">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="4" class="w-full rounded-lg border-slate-200" placeholder="Enter inspection notes, issues found, or remarks...">{{ $inspection->notes }}</textarea>
                    </div>
