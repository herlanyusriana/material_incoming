    ...
    <div class="space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-black text-slate-900">New OSP Order</h1>
                    <div class="mt-1 text-sm text-slate-600">Receive material from customer for assembly.</div>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            <form action="{{ route('outgoing.osp.store') }}" method="POST" class="space-y-6 max-w-2xl">
                ...
                {{-- Part --}}
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-1">Part (OSP) <span class="text-red-500">*</span></label>
                ...
                {{-- Qty --}}
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-1">Qty Material Received <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-1">Target Ship Date</label>
