            ...
            <div class="lg:col-span-2">
                <div class="bg-white border shadow-sm rounded-xl border-slate-200">
                    <div class="px-6 py-4 border-b border-slate-100">
                        ...
                        <p class="mt-1 text-sm text-slate-500">Accepted: <span class="font-mono">.xlsx</span>, <span
                                class="font-mono">.xls</span>, <span class="font-mono">.csv</span></p>
                    </div>

                    <form action="{{ route('outgoing.standard-packings.import') }}" method="POST"
            ...
            <div class="space-y-6">
                <div class="bg-white border shadow-sm rounded-xl border-slate-200">
                    ...
                    <div class="p-6">
                        <div class="text-sm rounded-lg bg-blue-50 text-blue-700 p-4 border border-blue-100">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                <li><span class="font-mono">customer</span> (recommended kalau part_no duplicate antar
                                    customer)</li>
                                <li><span class="font-mono">del_class</span> (default: <span class="font-mono">Main</span>)
                                </li>
                                <li><span class="font-mono">trolley_type</span></li>
                                <li><span class="font-mono">kemasan</span> (BAG, BOX, BUNDLE, TROLLEY)</li>
                ...
                <div class="bg-white border shadow-sm rounded-xl border-slate-200">
                    ...
                    <div class="p-6 text-sm text-slate-600 space-y-2">
                        ...
                        <div>- Import akan <span class="font-semibold">update/replace</span> data yang sama (<span
                                class="font-mono">part_no</span> + <span class="font-mono">del_class</span>).</div>
                    </div>
                </div>
            </div>
        </div>
