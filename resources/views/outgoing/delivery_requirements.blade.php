                    ...
                    <tbody class="bg-white">
                        @forelse ($displayRequirements as $idx => $req)
                            <tr class="hover:bg-slate-50 transition-colors border-b border-slate-100">
                                ...
                                <td class="px-3 py-3 text-center text-xs font-bold text-slate-700 border-x border-slate-100">
                                    @if(($req->source ?? '') === 'po')
                                        <span
                                            class="inline-block bg-amber-100 text-amber-700 text-[10px] font-bold px-1.5 py-0.5 rounded">PO</span>
                                    @endif
