                            ...
                            @forelse ($pendingArrivals as $arrival)
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <a href="{{ route('receives.invoice.create', $arrival) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm">
