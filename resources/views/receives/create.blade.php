                ...
                <td class="px-6 py-4">
                    <div class="flex items-center gap-2">
                        ...
                        <select name="tags[${tagIndex}][bundle_unit]" class="w-32 rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm py-2" required>
                            ...
                            <option value="BAG" ${defaultBundleUnit === 'BAG' ? 'selected' : ''}>BAG</option>
                            <option value="PACKAGES" ${defaultBundleUnit === 'PACKAGES' ? 'selected' : ''}>PACKAGES</option>
                            <option value="ROLL" ${defaultBundleUnit === 'ROLL' ? 'selected' : ''}>ROLL</option>
                        </select>
                    </div>
                </td>
                <td class="px-6 py-4">
