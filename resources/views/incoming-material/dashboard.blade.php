    ...
    <div class="space-y-6">
        <div class="bg-white border border-slate-200 rounded-2xl shadow-lg shadow-blue-500/5 p-6">
            <div class="flex items-center justify-between flex-wrap gap-4">
                <div>
                    <h2 class="text-xl font-semibold text-slate-900">{{ __('incoming.dashboard.title') }}</h2>
                    <p class="text-sm text-slate-500">{{ __('incoming.dashboard.subtitle') }}</p>
                </div>
                <span class="px-3 py-1 text-xs font-semibold uppercase tracking-wide bg-indigo-50 text-indigo-600 rounded-full">{{ __('incoming.dashboard.module') }}</span>
            </div>
            ...
            <div class="mt-6 grid gap-4 sm:grid-cols-2">
                <a href="{{ route('departures.create') }}" class="block border border-blue-100 rounded-xl p-4 bg-gradient-to-br from-white to-blue-50 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs uppercase tracking-wide text-blue-500 font-semibold">{{ __('incoming.dashboard.create') }}</p>
                            <h3 class="mt-1 text-lg font-bold text-slate-900">{{ __('incoming.dashboard.new_departure') }}</h3>
                            <p class="text-sm text-slate-600 mt-1">{{ __('incoming.dashboard.new_desc') }}</p>
                        </div>
                ...
                <a href="{{ route('departures.index') }}" class="block border border-slate-200 rounded-xl p-4 bg-white hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs uppercase tracking-wide text-slate-500 font-semibold">{{ __('incoming.dashboard.monitor') }}</p>
                            <h3 class="mt-1 text-lg font-bold text-slate-900">{{ __('incoming.dashboard.list') }}</h3>
                            <p class="text-sm text-slate-600 mt-1">{{ __('incoming.dashboard.list_desc') }}</p>
                        </div>
                ...
                <a href="{{ route('receives.index') }}" class="block border border-slate-200 rounded-xl p-4 bg-white hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs uppercase tracking-wide text-slate-500 font-semibold">{{ __('incoming.dashboard.operate') }}</p>
                            <h3 class="mt-1 text-lg font-bold text-slate-900">{{ __('incoming.dashboard.process') }}</h3>
                            <p class="text-sm text-slate-600 mt-1">{{ __('incoming.dashboard.process_desc') }}</p>
                        </div>
                ...
                <a href="{{ route('receives.completed') }}" class="block border border-slate-200 rounded-xl p-4 bg-white hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs uppercase tracking-wide text-slate-500 font-semibold">{{ __('incoming.dashboard.review') }}</p>
                            <h3 class="mt-1 text-lg font-bold text-slate-900">{{ __('incoming.dashboard.completed') }}</h3>
                            <p class="text-sm text-slate-600 mt-1">{{ __('incoming.dashboard.completed_desc') }}</p>
                        </div>
