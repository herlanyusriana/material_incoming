...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('delivery_plans')) {
        ...
        if (Schema::hasTable('delivery_notes')) {
            Schema::table('delivery_notes', function (Blueprint $table) {
                if (!Schema::hasColumn('delivery_notes', 'delivery_stop_id')) {
                    $table->foreignId('delivery_stop_id')->nullable()->constrained('delivery_stops')->nullOnDelete();
                }
                if (!Schema::hasColumn('delivery_notes', 'delivery_plan_id')) {
        ...
        if (Schema::hasTable('delivery_notes')) {
            Schema::table('delivery_notes', function (Blueprint $table) {
                if (Schema::hasColumn('delivery_notes', 'delivery_stop_id')) {
                    ...
                    $table->dropColumn('delivery_stop_id');
                }
                if (Schema::hasColumn('delivery_notes', 'delivery_plan_id')) {
                    try {
                    ...
                    $table->dropColumn('delivery_plan_id');
                }
            });
        }
