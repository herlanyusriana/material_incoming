...
class ReceiveController extends Controller
{
    ...
    public function store(Request $request, ArrivalItem $arrivalItem)
    {
        ...
        $validated = $request->validate([
            ...
            'tags.*.bundle_unit' => 'required|in:PALLET,BUNDLE,BOX,BAG,ROLL,PACKAGE',
    ...
    public function storeByInvoice(Request $request, Arrival $arrival)
    {
        ...
        if ($tagMode === 'no_tag') {
            $rules += [
                ...
                'items.*.summary.bundle_unit' => ['nullable', 'in:PALLET,BUNDLE,BOX,BAG,ROLL,PACKAGE'],
            ...
            $rules += [
                ...
                'items.*.tags.*.bundle_unit' => ['required_with:items.*.tags', 'in:PALLET,BUNDLE,BOX,BAG,ROLL,PACKAGE'],
    ...
    public function update(Request $request, Receive $receive)
    {
        ...
        $validated = $request->validate([
            ...
            'bundle_unit' => ['required', 'in:PALLET,BUNDLE,BOX,BAG,ROLL,PACKAGE'],
