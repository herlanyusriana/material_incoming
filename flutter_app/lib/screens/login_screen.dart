        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text('Material Tracker', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                ...
                TextFormField(
                  ...
                  validator: (v) => v != null && v.trim().isNotEmpty ? null : 'Username wajib diisi',
                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      tooltip: _obscurePass ? 'Tampilkan password' : 'Sembunyikan password',
                      icon: Icon(_obscurePass ? Icons.visibility : Icons.visibility_off),
                      onPressed: () => setState(() => _obscurePass = !_obscurePass),
                    ),
                  ),
                  validator: (v) => v != null && v.length > 3 ? null : 'Min 4 chars',
                ),
